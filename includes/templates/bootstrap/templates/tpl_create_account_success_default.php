            ...
            <div id="addressBookSingleEntryId<?php echo $addresses['address_book_id']; ?>-card" class="card mb-3<?php echo $primary_class; ?>">
                ...
                <div id="addressBookSingleEntryId<?php echo $addresses['address_book_id']; ?>-card-body" class="card-body p-3">
                    ...
                    <div class="btn-toolbar justify-content-between my-3" role="toolbar">
                        <?php echo zca_button_link(zen_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $addresses['address_book_id'], 'SSL'), BUTTON_DELETE_ALT, 'button_delete'); ?>
                        <?php echo zca_button_link(zen_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL'), BUTTON_EDIT_SMALL_ALT, 'edit_small'); ?>
                    </div>
                </div>
            </div>
...
<!--bof address details card-->
    ...
    <div id="createAccountSuccessDefault-btn-toolbar" class="btn-toolbar justify-content-end mt-3" role="toolbar">
        <?php echo zca_button_link($origin_href, BUTTON_CONTINUE_ALT, 'button_continue'); ?>
    </div>
</div>
