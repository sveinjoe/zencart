...
<div id="documentGeneralInfo" class="centerColumn">
...
<div id="documentGeneralInfo-productCategoryIcon" class="productCategoryIcon">
<?php
/**
...
<div id="documentGeneralInfo-productPrevNextTop" class="productPrevNextTop">
<?php
/**
...
<!--bof Product Name-->
<h1 id="documentGeneralInfo-productName" class="productName"><?php echo $products_name; ?></h1>
<!--eof Product Name-->

<div id="documentGeneralInfo-displayRow" class="row">
   <div id="documentGeneralInfo-displayColLeft"  class="col-sm mb-3">

<!--bof Main Product Image -->
<?php
  if (!empty($products_image)) {
  ?>
<div id="documentGeneralInfo-productMainImage" class="productMainImage pt-3 text-center">
<?php
/**
...
<div id="documentGeneralInfo-productAdditionalImages" class="productAdditionalImages text-center">
<?php
/**
...
<div id="documentGeneralInfo-productDescription" class="productDescription mb-3"><?php echo stripslashes($products_description); ?>
</div>
<?php } ?>
...
<!--eof Reviews button and count -->
  ...
  <div id="documentGeneralInfo-displayColRight"  class="col-sm mb-3">

<!--bof Product details list  -->
<?php if ( (($flag_show_product_info_model == 1 and $products_model != '') or ($flag_show_product_info_weight == 1 and $products_weight !=0) or ($flag_show_product_info_quantity == 1) or ($flag_show_product_info_manufacturer == 1 and !empty($manufacturers_name))) ) { ?>

<ul id="documentGeneralInfo-productDetailsList" class="productDetailsList list-group mb-3">
...
<div id="documentGeneralInfo-productFreeShippingIcon" class="productFreeShippingIcon text-center m-3"><?php echo TEXT_PRODUCT_FREE_SHIPPING_ICON; ?></div>
<?php } ?>
<!--eof free ship icon  -->
...
<div id="documentGeneralInfo-productQuantityDiscounts" class="productQuantityDiscounts">
<?php
/**
...
<div id="documentGeneralInfo-moduledDisplayRow" class="row">
    <?php if (PRODUCT_INFO_SHOW_NOTIFICATIONS_BOX == '1') { ?>
<!--bof Products Notification Module-->
   <div id="documentGeneralInfo-moduleDisplayColLeft" class="col-sm">
...
<!--bof Products Manufacturer Info Module-->
  <div id="documentGeneralInfo-moduleDisplayColRight" class="col-sm">
...
?>
<p id="documentGeneralInfo-productDateAvailable" class="productDateAvailable text-center">
...
?>
<p id="documentGeneralInfo-productDateAdded" class="productDateAdded text-center">
...
?>
<p id="documentGeneralInfo-productUrl" class="productUrl text-center">
...
<div id="documentGeneralInfo-productAlsoPurchased" class="productAlsoPurchased">
...
<div id="documentGeneralInfo-productPrevNextBottom" class="productPrevNextBottom">
<?php
/**
 * display the product previous/next helper
 */
