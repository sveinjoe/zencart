...
$define = [
    'ARIA_DELETE_ITEM_FROM_CART' => 'Eliminar este artículo del carrito',  
    'ARIA_EDIT_QTY_IN_CART' => 'Editar cantidad en el carrito',  
    'ARIA_PAGINATION_' => '', // 原始文本为空，因此无法翻译  
    'ARIA_PAGINATION_CURRENTLY_ON' => ', ahora en la página %s',  
    'ARIA_PAGINATION_CURRENT_PAGE' => 'Página Actual',  
    'ARIA_PAGINATION_ELLIPSIS_NEXT' => 'Obtener siguiente grupo de páginas',  
    'ARIA_PAGINATION_ELLIPSIS_PREVIOUS' => 'Obtener grupo anterior de páginas',  
    ...
    'ARIA_PAGINATION_ROLE_LABEL_FOR' => 'Paginación %s',  
    'ARIA_PAGINATION_ROLE_LABEL_GENERAL' => 'Paginación',  
    'ARIA_QTY_ADD_TO_CART' => 'Ingresa la cantidad para añadir al carrito',  
    'ASK_A_QUESTION' => 'Preguntar sobre este artículo',  
