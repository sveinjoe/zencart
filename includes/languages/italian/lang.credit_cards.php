...
$define = [
    'TEXT_ACCEPTED_CREDIT_CARDS' => '<strong>Accettiamo:</strong> ',  
    'TEXT_CC_ENABLED_VISA' => 'Visa',  
    'TEXT_CC_ENABLED_MC' => 'Mastercard',  // 通常MC代表Mastercard，而不是MC本身  
    'TEXT_CC_ENABLED_AMEX' => 'American Express',  // AmEx通常翻译为American Express  
