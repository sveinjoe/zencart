<?php
$define = [
    'MODULE_SHIPPING_STOREPICKUP_TEXT_TITLE' => 'Ritiro presso lo Store',  
    'MODULE_SHIPPING_STOREPICKUP_TEXT_DESCRIPTION' => 'Ritiro presso lo Store per il Cliente',  
    'MODULE_SHIPPING_STOREPICKUP_TEXT_WAY' => 'A piedi',  
    'MODULE_SHIPPING_STOREPICKUP_MULTIPLE_WAYS' => '',  // 这个值是空的，所以没有对应的翻译
];
