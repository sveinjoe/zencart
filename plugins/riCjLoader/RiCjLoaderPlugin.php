...
class RiCjLoaderPlugin
{
	...
	function loadFiles($files){
		...
		foreach($files as $_files){
			// bof modified for UP-183: Add Defer Option to CSS in CSS JS Loader : load css on the bottom of the page
			...
			// eof modified for UP-183: Add Defer Option to CSS in CSS JS Loader : load css on the bottom of the page
		}
