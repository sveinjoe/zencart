...
$define = [
    ...
    'SUCCESS_DISCOUNT_ALL' => '<strong>Successful</strong> Discount All Product: ',
    ...
    'TEXT_INFO_ALL_PRODUCT_DISCOUNT' => '<strong>所有产品打折（请填入大于0小于等于2的数字或者小数）</strong><br>如填写0.95,就是打九五折，如填写1.10就是涨价10%：',
