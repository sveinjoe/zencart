 ...
 * File Built by Zen Cart Installer on Fri May 19 2023 10:03:29
 */
 ...
 */
define('DIR_FS_CATALOG', dirname(dirname(__DIR__)).'/');
define('DIR_ADMIN_CATALOG', dirname(__DIR__).'/');
/**
 ...
 */
include(DIR_FS_CATALOG.'includes/db_config.php');
